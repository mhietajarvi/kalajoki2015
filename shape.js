...
function Sphere(o2w, w2o, ro, rad, z0, z1, pm) {
    ...
    this.radius = rad;
    this.zmin = Clamp(min(z0, z1), -radius, radius);
    this.zmax = Clamp(max(z0, z1), -radius, radius);
    this.thetaMin = acosf(Clamp(zmin/radius, -1.f, 1.f));
    this.thetaMax = acosf(Clamp(zmax/radius, -1.f, 1.f));
